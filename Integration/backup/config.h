...
#define is_fona       1		// 1 to enable cellular via Fona (808 version)
...
#if LOOM_DEBUG == 1
	#define SERIAL_BAUD 57600 			// Select Serial baudrate, only used supported rates (i.e. 9600, or 115200, etc.)
...
// --- nRF Options ---
	...
	#define nrf_data_rate 3 		// 1: 250kbs, 2: 1Mbps, 3: 2Mbps
									// -1: use default (1Mbps)
									// setting RF24_250KBPS will fail for non-plus units (not sure what this means)

	#define nrf_power_level 2		// 1: RF24_PA_MIN (-18dBm), 2: RF24_PA_LOW (-12dBm), 3: RF24_PA_HIGH (-6dBM), 4: RF24_PA_MAX (0dBm)
...
// --- PushingBox Options ---
	...
	//KEVINS: #define init_spreadsheet_id "1SufBxpLD6LKT_I2LWkUPODMCZl3Ns5vwwOwJfA5REmo"  // Ghana Proto Sheet
	#define init_spreadsheet_id "1Hv2oME5sjumUXv36GtFV1Q7I83xnXu-f-ZrxUNsXS_U"  // Ghana Proto Sheet
	...
	//KEVINS char device_id[] = "v70DD625CE559831"; 	// Opens

	char device_id[] = "v30C7C2EDE705157"; 	// Opens
	...
	#define useHubTabID 1  // Toggle option for below settings
		...
		#define init_tab_id "SS_opens_demo"    // Defines tab if hub is defining tab instead of node
	#else
		// Use bundle source and below prefix to define tab ID
		#define tab_id_prefix   ""		// Used as a prefix if node is being used to define tab
	#endif
