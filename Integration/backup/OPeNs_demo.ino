...
void pushString(char *nmea, uint8_t string_len)
{
//http://api.pushingbox.com/pushingbox?devid=v30C7C2EDE705157&key0=sheetID&val0=1Hv2oME5sjumUXv36GtFV1Q7I83xnXu-f-ZrxUNsXS_U&key1=tabID&val1=SS_opens_demo&key2=deviceID&val2=data&key3=full_data&val3=NMEA~$PSTI,032,002346.000,050219,V,,,,,,,,,,,*47
...
*/
    ...
    append_to_bundle_key_value(&bndl, "NMEA", nmea);
  }
  else
  {
...
void readBuffer()
{
  ...
  if (nmeaChar == '$')
  {
    ...
    while (nmeaChar != 0x0d)   //read until we hit the line feed return
    { 
  ...
  nmeaString[strlen(nmeaString)-1] ='\0';
  /*
  int i;
  Serial.println("-----------------------");
